...
U11_RE = re.compile(r"\bu\s?[-–]?\s?11\b|\bunder\s?[-–]?\s?11\b", re.IGNORECASE)
...
def is_u11(tournament):
    return bool(U11_RE.search(tournament.get("name") or ""))
...
class TrackerApp:
    ...
    def _build_table(self, parent):
        columns = ("date", "name", "location", "due", "dist", "fide", "u11", "tc", "category")
        headings = {
            "date": "Start",
            "name": "Tournament",
            "location": "Location",
        ...
        self.table.column("u11", width=52, anchor="center")
    ...
    def show_details(self, _event=None):
        ...
        lines += [
            ...
            f"U-11 friendly {'Yes' if is_u11(t) else 'No'}",
    ...
    def _score(self, t):
        ...
        if is_u11(t) and not (age and age <= 11):
            score -= 10
    ...
    def show_compare(self):
        ...
        rows = [
            ...
            ("U-11", lambda t: "Yes" if is_u11(t) else "No"),
